...
const LogList = React.forwardRef(({ logs, onDelete, onEdit }, ref) => {
  ...
  return (
    // Attach the ref to the main container div that we want to print
    <div ref={ref}> 
            ...
            {logs.map(log => (
              <div key={log._id} className="p-4 rounded-lg border border-base-300">
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex gap-2 print:hidden"> {/* Hide buttons on print */}
